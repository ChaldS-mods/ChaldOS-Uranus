...
[Veuillez consulter notre site web](https://github.com/ChaldS-mods/ChaldOS-Uranus) pour une explication conviviale de Bazzite destinée aux nouveaux utilisateurs. Ce fichier readme couvrira tout en détail.

[Bazzite](https://github.com/ChaldS-mods/ChaldOS-Uranus) est une image [Fedora Atomic](https://fedoraproject.org/atomic-desktops/) personnalisée construite avec la technologie [cloud native](https://universal-blue.org/#cloud-native) qui apporte le meilleur du gaming Linux sur **tous vos appareils - y compris votre console portable préférée**.
...
Le Secure Boot est pris en charge avec notre clé personnalisée. La clé publique peut être trouvée à la racine de ce dépôt [ici](https://github.com/ChaldS-mods/ChaldOS-Uranus/blob/main/secure_boot.der).
